...
#     index = pd.read_csv(f"{path}\\filtered_lengths_index.csv")


#     # Checking if the cleanup results
#     print(len(index[index['beatmap_length'] > LENGTH_THRESHOLD]))
#     print(len(index[index['star_rating'] > STAR_RATING_THRESHOLD]))
#     print(len(index[index['performance-Accuracy'] < ACCURACY_THRESHOLD]))
